class ClaudeCodeAnalytics < Formula
  ...
  sha256 "" # Will be generated after creating v1.0.0 tag
  license "MIT"
  ...
  # Placeholder resources - these will be auto-generated
  ...
  # Additional resources for: altair, google-generativeai, openai, jinja2, pyyaml, python-dotenv
  # Will be auto-generated by brew update-python-resources
